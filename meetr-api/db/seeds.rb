...
UserMeeting.create(user_id: 46, meeting_id: 1, start_latitude: 51.53289 , start_longitude: -0.13096 ,user_status: "created", start_address: "EC2A1AE" )
UserMeeting.create(user_id: 46, meeting_id: 4, start_latitude: 51.48881 , start_longitude: -0.22293 ,user_status: "invited")
UserMeeting.create(user_id: 46, meeting_id: 10, start_latitude: 51.52612 , start_longitude: -0.10722 ,user_status: "declined")
